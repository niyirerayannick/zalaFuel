...
def build_invoice_context(payment):
    ...
    return {
        ...
        "company_name": getattr(system_settings, "company_name", "ZALA/ECO ENERGY"),
...
def render_invoice_pdf(payment):
    ...
    verification_block = Table(
        [
            ...
            [Paragraph("Scan this QR code to open the ZALA/ECO ENERGY invoice verification page.", verify_style)],
        ],
        colWidths=[170 * mm],
    )
    ...
    story = [
        ...
        *payment_info_block,
        ...
        verification_block,
        Spacer(1, 4 * mm),
        Paragraph("Generated by ZALA/ECO ENERGY.", note_style),
    ]
    doc.build(story)
