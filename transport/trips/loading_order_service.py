...
def render_loading_order_pdf(trip):
    ...
    footer_note = Table(
        [[
            Paragraph(
                "This loading order was generated by ZALA/ECO ENERGY and confirms the dispatch details prepared for client execution.",
                note_style,
            ),
            Paragraph(
...
def send_loading_order_email(trip, *, created_by=None):
    ...
    email = send_atms_email(
        ...
        note="Review the attached loading order document and contact ZALA/ECO ENERGY if any dispatch detail needs adjustment.",
    )
