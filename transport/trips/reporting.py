...
def render_trip_report_pdf(trip):
    ...
    header_left.extend(
        [
            Paragraph("ZALA Terminal Trip Report", title_style),
            Paragraph("Operational trip summary generated from ZALA Terminal with shipment, financial, and invoice information.", subtitle_style),
        ]
    )
    header_meta_rows = [
        [
    ...
    story = [
        ...
        expense_table,
        Spacer(1, 2 * mm),
        Paragraph("Generated by ZALA Terminal.", subtitle_style),
    ]
    doc.build(story)
...
def render_trip_report_excel(trip):
    ...
    summary_sheet["C1"] = "ZALA Terminal Trip Report"
